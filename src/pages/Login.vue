    ...
    <div class="login">
      <div class="login-whole">
        ...
        <form class="tab-conter" @submit.prevent="onSubmits" v-bind:class="[current]">
          ...
          <div style="text-align: center;padding: 20px 13% 35px">
            <Button type="error" html-type="submit" size="large" long class="btn" id="btn" style="font-size:16px;">登录</Button>
          </div>
        </form>
      </div>
    </div>
